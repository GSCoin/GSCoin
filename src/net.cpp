...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GSCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
  {"seed1.gscoin.net", "seed1.gscoin.net"},
	{"seed2.gscoin.net", "seed2.gscoin.net"},
	{"seed3.gscoin.net", "seed3.gscoin.net"},
	{"seed4.gscoin.net", "seed4.gscoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GSCoin is probably already running."), addrBind.ToString().c_str());
        else
